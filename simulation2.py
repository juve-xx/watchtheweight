...
class simulation_net(nn.Module):
    def __init__(self,batch_size,lr):
        ...
        self.Net_name="simulation2_auto"+str(autosd)
        self.num=num
        ...
        self.epoch=50
        self.method="SGD"
        self.PATH = "/home/r4user1/RMTLearn/simulation2/" + self.Net_name + "/batch" + str(self.batch_size) + "/" + str(self.lr) + "/" + self.method
