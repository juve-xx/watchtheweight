...
PATH_SAVE="/home/r4user1/RMTLearn/AlexNet/batch"+str(batch_size)
...
transform = transforms.Compose(
    [transforms.ToTensor(),
     ...
     my_transform.AddGaussianNoise(amplitude=t)])#这里要观察数据channel是一还是三
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 96, 5,stride=1,padding=2)# channels, output, (height * width)
